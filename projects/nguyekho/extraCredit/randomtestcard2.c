 ...
 * randomtestcard2.c
 *
 * This file includes tests for card great_hall
 *
...
int randomtestcard2(int* test_1a_success, int* test_1a_failure,
...
int main() {
  ...
  printf("Test 1b - cardEffect() correctly reserves handCount of the player (drawn 1 card and discarded great_hall). Success: %d, Failure: %d\n", test_1b_success, test_1b_failure);
  printf("Test 1c - cardEffect() correctly places great_hall into the played pile. Success: %d, Failure: %d\n", test_1c_success, test_1c_failure);
  printf("Test 1d - cardEffect() correctly increases playedCardCount by 1. Success: %d, Failure: %d\n", test_1d_success, test_1d_failure);
  printf("Test 1e - cardEffect() correctly decreases player's deckCount by 1. Success: %d, Failure: %d\n", test_1e_success, test_1e_failure);
  ...
  printf("Test 1g - cardEffect() correctly increases the number of actions by 1. Success: %d, Failure: %d\n", test_1g_success, test_1g_failure);
  ...
  printf("Test 2b - cardEffect() correctly reserves handCount of the player (drawn 1 card and discarded great_hall). Success: %d, Failure: %d\n", test_2b_success, test_2b_failure);
  printf("Test 2c - cardEffect() correctly places great_hall into the played pile. Success: %d, Failure: %d\n", test_2c_success, test_2c_failure);
  printf("Test 2d - cardEffect() correctly increases playedCardCount by 1. Success: %d, Failure: %d\n", test_2d_success, test_2d_failure);
  printf("Test 2e - cardEffect() correctly updates player's deckCount (equal old discardCount - 1). Success: %d, Failure: %d\n", test_2e_success, test_2e_failure);
  ...
  printf("Test 2g - cardEffect() correctly increases the number of actions by 1. Success: %d, Failure: %d\n", test_2g_success, test_2g_failure);
...
//    printf("----------Random Card Test 3: Testing great_hall card effect----------\n\n");
